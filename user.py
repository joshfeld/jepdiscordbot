    ...
    def update_record(self, clue_id=None, show_id=None, jep_round=None, cash=0):
        ...
        with sqlite3.connect('jepbot.db') as conn:
            ...
            if clue_id is not None and show_id is not None:
                transact = (self.get_user_id, clue_id, show_id, correct, cash)
                cur.execute("""INSERT INTO transactions(user_id, clue_id, show_id, answered_correctly, winnings_change)
                    VALUES(?, ?, ?, ?, ?);""", transact)
